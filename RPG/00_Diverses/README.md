...
| ☑️   |                      | #254   | Integrate display into existing `printStatus()` method of the Game class                          |
...
| ☑️   |                      | #257   | Implement confusion effect: enemy attacks itself or its minion for 1 round                        |
